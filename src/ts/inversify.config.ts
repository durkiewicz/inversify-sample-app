...
container.bind(sharedTypes.ReducerContributorDepth1).to(ChangeSearchPhraseReducer);
container.bind(sharedTypes.ReducerContributorDepth1).to(SearchLibrariesSuccessReducer);
